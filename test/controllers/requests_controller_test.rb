...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { isbn: @request.isbn, name: @request.name, title: @request.title } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { isbn: @request.isbn, name: @request.name, title: @request.title } }
